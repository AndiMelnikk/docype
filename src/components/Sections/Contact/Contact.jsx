        ...
        <div className="container">
          <HeaderInfo>
            <Animates animate="animate__flipInX" time="animate__fast" showInterest="0.3">
              ...
              <p className="font13">
                Якщо виникають питання або вирішили співпрацювати, зв'язуйтесь з нами. Можна надіслати лист на пошту, зателефонувати,
                <br />
              ...
              <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 flex">
                ...
                <div style={{ width: "50%" }}>
                  <div style={{ marginTop: "100px" }}>
                    <Animates animate="animate__fadeInRightBig" time="animate__fast" showInterest="0.5">
